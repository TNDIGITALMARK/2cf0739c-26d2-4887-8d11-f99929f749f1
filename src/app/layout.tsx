    ...
    <html lang="fr" suppressHydrationWarning>
      <head>
        ...
        {(process.env.NODE_ENV === 'development' ||
          ...
          <>
            <link rel="stylesheet" href="/phoenix-editor/helper.css?v=1763064482853" />
            <script
              src="/phoenix-editor/sourceMapTracker.js?v=1763064482853"
              data-phoenix-sourcemap="true"
              defer
            />
            <script
              src="/phoenix-editor/helper.js?v=1763064482853"
              data-phoenix-enabled="true"
              defer
            />
            <script
              src="/phoenix-editor/visualEditExtension.js?v=1763064482853"
              data-phoenix-visual-edit="true"
              defer
            />
            <script
              src="/phoenix-editor/contextIntegration.js?v=1763064482853"
              data-phoenix-context="true"
              defer
            />
            <script
              src="/phoenix-editor/inlineTextEditor.js?v=1763064482853"
              data-phoenix-text-edit="true"
              defer
            />
            <script
              src="/phoenix-editor/inlineClassEditor.js?v=1763064482853"
